...
public class CategoryCreateDTO {
  ...
  @CosmicWordCheck(
      message = "Category name must contain cosmic terms for our intergalactic marketplace")
  ...
  @Schema(
      ...
      example = "Electronic devices from across the galaxy")
  String description;
  ...
  List<
          ...
          @Size(min = 2, max = 20, message = "Tag must be between 2 and 20 characters") String>
      tags;
}
