...
public class ProductCreateDTO {
  ...
  @CosmicWordCheck(
      message = "Product name must contain cosmic terms for our intergalactic marketplace")
  ...
  @Schema(
      ...
      example = "High-quality cosmic headphones with stellar noise cancellation technology")
  String description;
