...
public class ProductUpdateDTO {
  ...
  @CosmicWordCheck(
      required = false,
      message = "Product name should contain cosmic terms for our intergalactic marketplace")
  ...
  @Schema(
      ...
      example = "Premium wireless headphones with enhanced noise cancellation")
  String description;
  ...
  @Schema(
      ...
      example = "https://example.com/images/headphones-pro.jpg")
  String image;
